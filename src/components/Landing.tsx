...
const projectData = [
  ...
  },
  {
    title: 'FitMate',
    description:
      "FitMate is a fitness and nutrition companion that helps you stay active, explore food nutrition information, and keep track of your fitness journey. Whether you're starting your fitness journey or maintaining a healthy lifestyle, FitMate provides simple tools to support your daily routine.",
  ...
  },
  {
    title: 'StudyOrbit',
    description:
      'StudyOrbit is a student-focused social learning platform where students can share and discover study content, tech updates, hackathons, internships, and educational opportunities in one place. It combines social networking with academic and career-focused resources.',
